...
Sou Desenvolvedora focada em soluções Low-Code/No-Code (OutSystems) e integrações de sistemas. 
Com 3 anos de experiência no mercado, adoro transformar problemas complexos em aplicações eficientes e organizadas.

- 🔭 Atualmente trabalho como Desenvolvedora, criando e otimizando aplicações empresariais.
